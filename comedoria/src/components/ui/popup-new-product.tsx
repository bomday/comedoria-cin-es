...
export default function NewProduct({ isOpen, onClose, onSave }: NewProductProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log('New product:', { name, type, value, flavors: flavors.filter(f => f.checked).map(f => f.name) })
    onSave()
    onClose()
  }
        ...
        <div className="p-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Button type="button" onClick={addNewFlavor} className="bg-[#FFA500] hover:bg-[#FF8C00] text-white">
